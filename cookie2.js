...
//     while (Date.now() - start < 10) {}
    ...
    console.log("After deleting, cookie 2", decodeURIComponent(document.cookie).split("; ")); 
...
console.log("cookie2_timeStamp =", timeStamp);

for ( var i = 0; i < 10; i++ ) {
  pieceOfData1.cookie2_timeStamp = timeStamp;
  pieceOfData1[ 'param_varam_index_' + i ] = 'dynamic_index_param_value_' + i +  ' cookie2_timeStamp = ' + timeStamp;
  ...
  pieceOfData2.cookie2_timeStamp = timeStamp;
  pieceOfData2[ 'temp_varam_param' + i ] = 'ind_value_' + i +  ' cookie2_timeStamp = ' + timeStamp;
